namespace Hackathon_2024_API.Data.Consts
{
    public class ResponseMessages
    {
            ...
            public const string ENTITY_EXISTS = "An entity with this email or id already exists. Please verify the data to avoid duplicates.";
